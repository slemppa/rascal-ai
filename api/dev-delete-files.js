...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`[dev-delete-files] Poistetaan ${ids.length} dokumenttia taulusta ${tableName}`)
    ...
    console.log(`[dev-delete-files] ✅ Poistettu ${ids.length} dokumenttia onnistuneesti`)
