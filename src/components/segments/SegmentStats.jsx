...
export default function SegmentStats({ segmentId }) {
  ...
  if (loading) return <div>Ladataan tilastoja...</div>
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 12 }}>
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 12 }}>
        <div style={{ color: '#6b7280', fontSize: 12 }}>Puhelut</div>
        <div style={{ fontSize: 18, fontWeight: 700 }}>{total}</div>
      </div>
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 12 }}>
        <div style={{ color: '#6b7280', fontSize: 12 }}>Vastatut</div>
        <div style={{ fontSize: 18, fontWeight: 700 }}>{answered}</div>
      </div>
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 12 }}>
        <div style={{ color: '#6b7280', fontSize: 12 }}>Onnistuneet</div>
        <div style={{ fontSize: 18, fontWeight: 700 }}>{success}</div>
      </div>
      <div style={{ border: '1px solid #e5e7eb', borderRadius: 8, padding: 12 }}>
        <div style={{ color: '#6b7280', fontSize: 12 }}>Vastaus%</div>
