...
describe('useMonthlyLimit', () => {
  ...
  beforeEach(() => {
    ...
    const { getUserOrgId } = require('../lib/getUserOrgId')
    getUserOrgId.mockResolvedValue(mockUserId)
    
    const { supabase } = require('../lib/supabase')
    supabase.from.mockReturnValue(mockSupabaseQuery)
    
    strategyHelpers.calculateMonthlyLimit.mockReturnValue(30)
  })
  ...
  it('should fetch subscription status and calculate limit', async () => {
    ...
    const { supabase } = require('../lib/supabase')
    strategyHelpers.calculateMonthlyLimit.mockReturnValue(100)
    strategyHelpers.findStrategyByMonthAndYear.mockResolvedValue(null)
  ...
  it('should count generated content for current strategy', async () => {
    ...
    strategyHelpers.findStrategyByMonthAndYear.mockResolvedValue(mockStrategy)
  ...
  it('should handle enterprise unlimited plan', async () => {
    ...
    strategyHelpers.calculateMonthlyLimit.mockReturnValue(999999)
    strategyHelpers.findStrategyByMonthAndYear.mockResolvedValue(null)
